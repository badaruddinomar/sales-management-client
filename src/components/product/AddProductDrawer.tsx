...
import { z } from "zod";
import { useAddProductMutation } from "@/redux/apiClient/productApi";
...
const AddProductDrawer = ({ isDrawerOpen, hideDrawerHandler }: IProps) => {
  const [addProductHandler, { isLoading }] = useAddProductMutation();
